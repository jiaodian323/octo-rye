package com.justnd.octoryeclient.widget.banner;
 ...
 * 自定义Banner无限轮播控件
 */
public class BannerView extends RelativeLayout implements BannerAdapter
        .ViewPagerOnItemClickListener {
    public static final String TAG = "BannerView_JD";
    ...
    private void startScroll() {
        ...
        Log.i(TAG, compositeSubscription.toString());
    }
