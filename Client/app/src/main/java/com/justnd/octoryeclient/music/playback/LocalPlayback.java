...
public final class LocalPlayback implements Playback {
    ...
    private final class ExoPlayerEventListener implements Player.EventListener {
        @Override
        public void onTimelineChanged(Timeline timeline, Object manifest, int integer) {
            // Nothing to do.
        }
        ...
        @Override
        public void onShuffleModeEnabledChanged(boolean bool) {
            // Nothing to do.
        }

        @Override
        public void onPositionDiscontinuity(int integer) {
            // Nothing to do.
        }
